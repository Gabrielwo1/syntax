      ...
      <div className="bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <input value={title} onChange={e => setTitle(e.target.value)} required placeholder="Título do documento" className="w-full px-3 py-2 bg-zinc-950 border border-zinc-700 rounded-lg text-sm text-zinc-50 placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500" />
          </div>
